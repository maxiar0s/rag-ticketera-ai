...
from app.utils.nodes.llm_config import llm
...
def test_tool_usage():
    ...
    # Mensaje del usuario
    user_message = HumanMessage(content="Hola, soy el usuario 1. ¿Qué tickets tengo pendientes?")
    
    messages = [system_prompt, user_message]
    
    try:
        print(f"Modelo configurado: {llm.bound.model}")
