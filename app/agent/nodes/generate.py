...
def generate_node(state: AgentState):
    ...
    8. Para crear ticket debes usar la tool `crear_ticket_soporte` cuando tengas, como minimo: user_id, casa_matriz_id y descripcion. Si falta informacion, pide solo los datos faltantes de forma breve y en pasos.
